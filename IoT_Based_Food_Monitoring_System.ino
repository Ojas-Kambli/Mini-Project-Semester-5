...
const char* ssid = "*****";
const char* password = "*****";//"JwR7nSdMqL;Pu";
...
void loop() 
{
 ...
 Serial.println(gas);
  ...
  if (isnan(gas))
  {
    Serial.println("Failed to read from MQ4 sensor!");
  }
 ...
 else 
 {
  ...
  ThingSpeak.writeField(myChannelNumber, 4,mo, myWriteAPIKey);
  Blynk.run();
  Write();
  delay(2000);
}
